    ...
    async function _performInitialSync() {
        ...
        try {
            ...
            if (hasLocal && !hasCloud) {
                ...
                // Parallel uploads (batched) instead of sequential
                const uploadTasks = [];
        ...
        Auth: {
            ...
            async signUp(email, password) {
                ...
                if (result.session && result.user) {
                    ...
                    // Start sync in background — don't block sign-up
            ...
            async signIn(email, password) {
                ...
                if (result.session && result.user) {
                    ...
                    // Start sync in background — don't block sign-in
                    // Dashboard shows instantly with local data, refreshes when sync completes
                    _performInitialSync().catch(e => {
                        console.warn('[StorageAdapter] Background sync failed:', e);
                    });
                }
